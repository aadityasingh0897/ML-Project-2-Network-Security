...
class TrainingPipeline:
    ...
    def start_modfel_trainer(self, data_transformation_artifact: DataTransformationArtifact):
        try:
    ...
    def run_pipeline(self):
        try:
            ...
            model_trainer_artifact = self.start_modfel_trainer(data_transformation_artifact=data_transformation_artifact)
            return model_trainer_artifact
        except Exception as e:
            raise NetworkSecurityException(e, sys)